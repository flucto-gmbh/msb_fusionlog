...
def get_interval_file_handle(interval : int, log_file_prefix : str, log_dir : str, verbose=False) -> TextIOWrapper :
    ...
    if verbose: print(f'new file handle: {filepath}')
...
def main():
    ...
    next_interval_epoch, file_handle = update_interval_file_handle(current_interval=current_interval_epoch, current_file_handle=file_handle, log_file_prefix="test", log_dir=".")
